...
if __name__ == "__main__":
    ...
    save_path = args.save_dir    ## dataset/news

    # load data
    path = args.data_path    ## 'dataset/news/news_pp.npy'
    news = np.load(path)
    #
    # # normalize data
    ...
    num_data = news.shape[0]     ## 2993
    num_feature = news.shape[1]  ## 498
    ...
    def news_matrix():
        data_matrix = torch.zeros(num_data, num_feature+2) ## 2993,498+2
        # get data matrix
